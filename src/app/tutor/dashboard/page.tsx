...
export default function TutorDashboard() {
  ...
  const [helpUrgency, setHelpUrgency] = useState<"urgent" | "non-urgent">(
    "non-urgent"
  );
  ...
  const handleCancelJob = async (jobId: string, opportunityId: string) => {
    ...
    try {
      ...
      setSuccessMessage("Tutoring job cancelled successfully.");
    } catch (err) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                  ...
                  <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center group-hover:bg-blue-200 transition-colors">
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth="2"
                        d="M8 10h.01M12 10h.01M16 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9 5h.01"
                      />
                    </svg>
                  </div>
                </div>
                <div className="ml-4 text-left">
                  ...
                  <p className="text-sm text-gray-500 group-hover:text-blue-700">
                    Request help from Tutoring Executives
                  </p>
                </div>
              </button>
            </div>
                              ...
                              <div>
                                ...
                                <div className="text-sm text-gray-600 space-y-1">
                                  ...
                                  <p>
                                    ...
                                    {(() => {
                                      const g =
                                        job.tutoring_opportunity?.tutee_grade ||
                                        job.tutoring_opportunity?.grade ||
                                        job.tutee?.grade;
                                      return g || "—";
                                    })()}
                                  </p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative w-full max-w-lg">
            ...
            <div className="relative bg-white/90 backdrop-blur shadow-xl ring-1 ring-gray-200 rounded-2xl p-6">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Request help from Tutoring Club Executives.
              </p>
              <div className="grid grid-cols-1 gap-3 mb-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setHelpUrgency(
                        (e.target.value as "urgent" | "non-urgent") ||
                          "non-urgent"
                      )
                    }
                  >
              ...
              <div className="flex justify-end gap-2">
                <button
                  className="px-3 py-1.5 border border-gray-200 rounded-xl hover:bg-gray-50"
                  onClick={() => setShowHelpModal(false)}
                >
                  Cancel
                </button>
